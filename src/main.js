window.addEventListener("load" , () => {
    ...
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(position => {
            ...
            const api3 = `http://api.openweathermap.org/data/2.5/air_pollution?lat=${lat}&lon=${lon}&appid=${APIkey}&units=metric&lang=PL`
            ...
            fetch(api)
                    ...
                    .then(data => {
                        ...
                        cloudsValue.innerHTML = `chmury ${clouds}%`;
            ...
            fetch(api3)
                ...
                .then(res => {
                        ...
                        } else if (Math.floor((pm10 / 50) * 100) > 30 && Math.floor((pm10 / 50) * 100) <= 75) {
                        ...
                        } else if (Math.floor((pm2_5 / 25) * 100) > 30 && Math.floor((pm2_5 / 25) * 100) <= 75) {
                        ...
                        } else if (Math.floor((so2 / 125) * 100) > 30 && Math.floor((so2 / 125) * 100) <= 75) {
